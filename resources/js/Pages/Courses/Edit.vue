                ...
                <div class="w-full">
                    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" @submit.prevent="submit">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-10" v-for="(episode, index) in courseData.episodes" v-bind:key="index">
                                ...
                                <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :id="'description-'+index" type="text" v-model="courseData.episodes[index].description"></textarea>
                                ...
                                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :id="'video_url-'+index" type="text" v-model="courseData.episodes[index].video_url">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex">
                                <button class="bg-green-600 py-2 px-4 rounded mx-2 text-white block" v-if="courseData.episodes.length < 15" @click.prevent="add">+</button>
                                <button class="bg-red-600 py-2 px-4 rounded mx-2 text-white block" v-if="courseData.episodes.length > 1" @click.prevent="remove">-</button>
                            </div>
